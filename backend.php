...
function alterarPassword(){
    ...
    function eliminarUtilizador(){
        ...
        $delete_query = "DELETE FROM gestor_login WHERE id = '{$id}'";
...
<br><br>
<form action="backend.php" method="POST" ecntype="multipart/form-data">
    <section class="inserir_dados">
    <input type="number" name="idEquipamento" placeholder="Selecionar registos por id">
    <br><br>
    <button  type="submit" name="eliminar">Eliminar Equipamento</button>
    <br><br>
...
<?php
    function eliminarEquipamento(){
        include("BD_connection.php");
            ...
            if(is_numeric($POST_['idEquipamento'])){
                $id= $_POST["idEquipamento"];
